package com.aariyan.linxtimeandbilling.Constant;

public class Constant {

    public static final String URL_USER_LIST = "http://102.37.0.48/scannergrv/GetUserAndRoles.php?location=MSTR";
    public static final String URL_VENDOR_LIST = "http://102.37.0.48/scannergrv/GetVendors";
